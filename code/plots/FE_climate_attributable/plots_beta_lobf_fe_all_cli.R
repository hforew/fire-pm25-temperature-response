...
##
## Goal: Visualise country-level FE regression outputs from fpm_gmt_regression_FE_all_cli.R.
...
##
## Inputs:
##   code/regression_alpha/fpm_gmt_regression_FE_all_cli.R   (sourced directly; provides
##     reg_coefs, reg_data_combined, reg_results)
##
## Outputs:
##   images/regression_alpha/beta_FE_all_cli/hist_beta_c_fe.png
##   images/regression_alpha/beta_FE_all_cli/map_beta_c_fe.png
##   images/regression_alpha/beta_FE_all_cli/multiplot_beta_c_wide.png
##   images/regression_alpha/beta_FE_all_cli/lof_{iso}_fe.png   (one per country in countries_to_plot)
##   images/regression_alpha/beta_FE_all_cli/lof_multi_fe.png
##
## Execution order:
##   files run before: fpm_gmt_regression_FE_all_cli.R   --> sourced directly; runs automatically
##
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
hist_beta_c
ggsave(here("images/regression_alpha/beta_FE_all_cli", "hist_beta_c_fe.png"), plot = hist_beta_c, width = 8, height = 5, dpi = 300)
...
map_beta_c
ggsave(here("images/regression_alpha/beta_FE_all_cli", "map_beta_c_fe.png"),
       map_beta_c, width = 6.5, height = 3.5, dpi = 300)

print("Beta map saved to images/regression_alpha/beta_FE_all_cli/")
...
ggsave(here("images/regression_alpha/beta_FE_all_cli", "multiplot_beta_c_wide.png"),
       multiplot_wide, width = 8.5, height = 3.5, units = "in", dpi = 300)

print("Multiplot saved to images/regression_alpha/beta_FE_all_cli/")
...
scenario_lookup <- tibble(
  period_scenario = c(
    "exposure_percap_park_classic_1960s_fpm_cli", "exposure_percap_park_classic_1970s_fpm_cli",
    "exposure_percap_park_classic_1980s_fpm_cli", "exposure_percap_park_classic_1990s_fpm_cli",
    "exposure_percap_park_classic_2000s_fpm_cli", "exposure_percap_park_classic_2010s_fpm_cli",
    "exposure_percap_park_jules_1960s_fpm_cli",   "exposure_percap_park_jules_1970s_fpm_cli",
    "exposure_percap_park_jules_1980s_fpm_cli",   "exposure_percap_park_jules_1990s_fpm_cli",
    "exposure_percap_park_jules_2000s_fpm_cli",   "exposure_percap_park_jules_2010s_fpm_cli",
    "exposure_percap_park_ssib4_1960s_fpm_cli",   "exposure_percap_park_ssib4_1970s_fpm_cli",
    "exposure_percap_park_ssib4_1980s_fpm_cli",   "exposure_percap_park_ssib4_1990s_fpm_cli",
    "exposure_percap_park_ssib4_2000s_fpm_cli",   "exposure_percap_park_ssib4_2010s_fpm_cli",
...
for (iso in countries_to_plot) {
    ...
    mutate(
      ...
      label = case_when(
        period_scenario %in% c(
          "exposure_percap_park_classic_2010s_fpm_cli",
          "exposure_percap_park_jules_2010s_fpm_cli",
          "exposure_percap_park_ssib4_2010s_fpm_cli"
        ) ~ "Park et al.",
        period_scenario %in% c(
          "exposure_percap_fpm_2000",
  ...
  print(p)
  ggsave(here("images/regression_alpha/beta_FE_all_cli", paste0("lof_", tolower(iso), "_fe.png")),
         p, width = 7, height = 5, dpi = 300)
}


print("Line of best fit plots saved to images/regression_alpha/beta_FE_all_cli/")
...
print(p_multi)
ggsave(here("images/regression_alpha/beta_FE_all_cli", "lof_multi_fe.png"),
       p_multi, width = 8.5, height = 5, dpi = 300)

print("Multi-country grid saved to images/regression_alpha/beta_FE_all_cli/")
