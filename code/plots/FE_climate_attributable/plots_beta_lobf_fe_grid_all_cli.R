...
##
## Goal: Visualise grid-cell beta_i estimates from fpm_gmt_regress_FE_grid_all_cli.R.
##   Produces: (1) histogram of beta_i across all ~65k grid cells;
##   (2) world raster map of beta_i; (3) CONUS raster map of beta_i.
##
## Inputs:
##   output/fpm_gmt_regression_coefs_FE_grid_cli.csv   (beta_i per grid cell with SE,
##                                                       p-value, lon, lat)
##
## Outputs:
##   images/regression_alpha/beta_FE_grid_all_cli/hist_beta_i_fe_grid.png
##   images/regression_alpha/beta_FE_grid_all_cli/map_beta_i_fe_grid.png
##   images/regression_alpha/beta_FE_grid_all_cli/map_beta_i_fe_grid_usa.png
##
## Execution order:
...
# Grid-cell FE regression coefficients produced by fpm_gmt_regress_FE_grid_all_cli.R.
...
reg_coefs <- read_csv(here("output", "fpm_gmt_regression_coefs_FE_grid_cli.csv"))
...
hist_beta_i
ggsave(here("images/regression_alpha/beta_FE_grid_all_cli", "hist_beta_i_fe_grid.png"),
...
map_beta_i
ggsave(here("images/regression_alpha/beta_FE_grid_all_cli", "map_beta_i_fe_grid.png"),
...
map_beta_i_usa
ggsave(here("images/regression_alpha/beta_FE_grid_all_cli", "map_beta_i_fe_grid_usa.png"),
       map_beta_i_usa, width = 6.5, height = 3.5, dpi = 300)

print("Beta grid maps saved to images/regression_alpha/beta_FE_grid_all_cli/")
