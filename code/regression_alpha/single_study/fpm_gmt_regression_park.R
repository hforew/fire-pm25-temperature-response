...
write_csv(reg_coefs_classic, here("output", "fpm_gmt_regression_coefs_classic.csv"))
write_csv(reg_coefs_jules,   here("output", "fpm_gmt_regression_coefs_jules.csv"))
write_csv(reg_coefs_ssib4,   here("output", "fpm_gmt_regression_coefs_ssib4.csv"))

cat("\nSaved regression coefficients to:\n")
cat("  output/fpm_gmt_regression_coefs_classic.csv\n")
cat("  output/fpm_gmt_regression_coefs_jules.csv\n")
cat("  output/fpm_gmt_regression_coefs_ssib4.csv\n")
