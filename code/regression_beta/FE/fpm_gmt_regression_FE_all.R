...
##   output/gmt_pierce_RCPs.csv           (decadal mean GMT anomaly for Pierce periods ×
...
##
## Outputs:
##   output/betas_fe_all/fpm_gmt_regression_coefs_FE_all.csv   (beta_c per country with SE, CI,
##                                                  p-value, and gamma_beta_c; primary downstream input)
##   output/betas_fe_all/reg_data_combined_fe_all.csv           (combined long-format regression input:
...
##                    beta_GIVE_country_map.R   --> reads fpm_gmt_regression_coefs_FE_all.csv
...
write_csv(reg_coefs, here("output", "betas_fe_all", "fpm_gmt_regression_coefs_FE_all.csv"))

cat("\nSaved regression coefficients to output/betas_fe_all/fpm_gmt_regression_coefs_FE_all.csv\n")

# Save combined long-format regression input data for use in descriptive statistics script.
write_csv(reg_data_combined, here("output", "betas_fe_all", "reg_data_combined_fe_all.csv"))
cat("Saved combined regression input data to output/betas_fe_all/reg_data_combined_fe_all.csv\n")
