...
# Inputs : input/pierce_etal_2017/CESM_09x125_PM25_2000_Baseline.nc ;
...
pop_ssp1 <- nc_open(here("input", "pierce_etal_2017", "clmforc.Li_2018_SSP1_CMIP6_hdm_0.5x0.5_AVHRR_simyr1850-2100_c181205.nc"))
